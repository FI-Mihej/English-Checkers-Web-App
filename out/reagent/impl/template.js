...
return cljs.core._write.call(null,writer__6858__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__10315 = o;
(G__10315[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.truth_((function (){var and__6239__auto__ = cljs.core.some_QMARK_.call(null,reagent.impl.template.find_dom_node);
if(and__6239__auto__){
var and__6239__auto____$1 = cljs.core.some_QMARK_.call(null,jsprops);
...
var G__10323 = jsprops;
(G__10323["defaultValue"] = value);

(G__10323["onChange"] = ((function (G__10323,v,value,on_change){
return (function (p1__10321_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__10321_SHARP_);
});})(G__10323,v,value,on_change))
);
...
var vec__10330 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__10330,(0),null);
var id = cljs.core.nth.call(null,vec__10330,(1),null);
var class$ = cljs.core.nth.call(null,vec__10330,(2),null);
...
var jsprops = {"argv": v};
var temp__4661__auto___10335 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___10335 == null)){
} else {
var key_10336 = temp__4661__auto___10335;
(jsprops["key"] = key_10336);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__10338 = (new reagent.impl.template.NativeWrapper());
(G__10338["name"] = c);
...
var len__7326__auto___10344 = arguments.length;
var i__7327__auto___10345 = (0);
while(true){
if((i__7327__auto___10345 < len__7326__auto___10344)){
args__7333__auto__.push((arguments[i__7327__auto___10345]));

var G__10346 = (i__7327__auto___10345 + (1));
i__7327__auto___10345 = G__10346;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq10342){
var G__10343 = cljs.core.first.call(null,seq10342);
var seq10342__$1 = cljs.core.next.call(null,seq10342);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__10343,seq10342__$1);
});
...
break;
default:
var G__10350 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__10350;
continue;
...
var n__7166__auto___10353 = a.length;
var i_10354 = (0);
while(true){
if((i_10354 < n__7166__auto___10353)){
(a[i_10354] = reagent.impl.template.as_element.call(null,(a[i_10354])));
...
var a = cljs.core.into_array.call(null,s);
var n__7166__auto___10356 = a.length;
var i_10357 = (0);
while(true){
if((i_10357 < n__7166__auto___10356)){
var val_10358 = (a[i_10357]);
if((cljs.core.vector_QMARK_.call(null,val_10358)) && ((reagent.impl.template.key_from_vec.call(null,val_10358) == null))){
(o["no-key"] = true);
} else {
}

(a[i_10357] = reagent.impl.template.as_element.call(null,val_10358));

var G__10359 = (i_10357 + (1));
i_10357 = G__10359;
continue;
} else {
}
...
var ctx = {};
var vec__10363 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__10363,(0),null);
var derefed = cljs.core.nth.call(null,vec__10363,(1),null);
...
var G__10367 = (cljs.core.count.call(null,argv) - first_child);
switch (G__10367) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__10367){
